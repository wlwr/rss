  ...
  var response =
    yield request({
      ...
      headers : {
        ...
        'Cookie': 'BTEST=7|1430464029|v1; IPLOC=CN4401; SUID=93B206B7260C930A000000005543261D; SUID=93B206B75FC00D0A000000005543261D; SUV=00001004B706B2935543261D51259284; weixinIndexVisited=1; sct=1; SNUID=4A6ADF6FD9DDCD2605479DE9D987AB98; wapsogou_qq_nickname=; LSTMV=295%2C112; LCLKINT=5961',
...
Weixin.prototype.getCookie = function*() {
  ...
  if (!result.error && result.statusCode == 200) {
    var cookie = result.headers['set-cookie'].join(';');
    return cookie;
  }  
}
